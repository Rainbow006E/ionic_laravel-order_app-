...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cart__ = __webpack_require__(855);
...
var CartPage = (function () {
    ...
    CartPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"F:\ionic\ionic_laravel\Jollibee-App\src\pages\ordering\cart\cart.html"*/'<ion-header>\n    <ion-navbar>\n        <button ion-button menuToggle *ngIf="loggedIn">\n            <ion-icon name="menu"></ion-icon>\n        </button>\n        <ion-title>\n            {{ \'cart.title\' | translate }}\n        </ion-title>\n    </ion-navbar>\n</ion-header>\n\n<ion-content class="products-content">\n    <div *ngIf="items.length == 0" class="text-center">\n        <br>\n        <br>\n        <br>\n        {{ \'cart.empty\' | translate }}\n    </div>\n    <div class="product" *ngFor="let item of items">\n        <div *ngIf="item.product.images.length > 0" class="product-images">\n            <img [src]="item.product.images[0]">\n        </div>\n        <div padding class="product-info">\n            <h2>{{ item.product.name }}</h2>\n            <p class="product-descr">{{ item.product.description }}</p>\n            <div class="product-price">\n                <span *ngIf="item.product.price_old && (item.product.price_old > item.product.price)"><s>{{ item.product.price_old }}</s></span>\n                <span>{{ item.product.price}}AED x {{item.count }} = {{ item.product.price * item.count}}AED</span>\n            </div>\n            <ion-row no-padding>\n                <ion-col>\n                    <button ion-button block outline color="light" icon-left (click)="decreaseCart(item)">\n                        -\n                    </button>\n                </ion-col>\n                <ion-col class="text-center product-count">\n                    {{ item.count }}\n                </ion-col>\n                <ion-col>\n                    <button ion-button block outline color="light" icon-left (click)="increaseCart(item)">\n                        +\n                    </button>\n                </ion-col>\n            </ion-row>\n        </div>\n    </div>\n</ion-content>\n<ion-footer [hidden]="items.length == 0">\n    <div class="cart-total">{{ \'cart.total\' | translate }}: {{ cartPrice() | ecurrency }}</div>\n    <button type="button" ion-button block (click)="showOrderModal()" class="place-order-button">\n        {{ \'cart.order\' | translate }}\n    </button>\n</ion-footer>'/*ion-inline-end:"F:\ionic\ionic_laravel\Jollibee-App\src\pages\ordering\cart\cart.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__services_cart_service__["a" /* CartService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_cart_service__["a" /* CartService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__services_api_service__["a" /* APIService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_api_service__["a" /* APIService */]) === "function" && _c || Object])
    ], CartPage);
    return CartPage;
    var _a, _b, _c;
}());
